...
class AllRestaurantScreen extends StatefulWidget {
  ...
  const AllRestaurantScreen({Key? key, required this.isPopular, required this.isRecentlyViewed, required this.isOrderAgain}) : super(key: key);
      ...
      builder: (restController) {
        return Scaffold(
          ...
          body: RefreshIndicator(
            ...
            child: Scrollbar(controller: scrollController, child: SingleChildScrollView(controller: scrollController, child: FooterView(
              child: Column(
                children: [
