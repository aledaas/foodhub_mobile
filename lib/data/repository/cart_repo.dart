...
class CartRepo{
  ...
  Future<Response> removeCartItemOnline(int cartId, String? guestId) async {
    return apiClient.postData('${AppConstants.removeItemCartUri}?cart_id=$cartId${guestId != null ? '&guest_id=$guestId' : ''}', {"_method": "delete"});
  }

  Future<Response> clearCartOnline(String? guestId) async {
    return apiClient.postData('${AppConstants.removeAllCartUri}${guestId != null ? '?guest_id=$guestId' : ''}', {"_method": "delete"});
  }
